...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha2.ACMEIssuerDNS01ProviderSakuraCloud)(nil), (*acme.ACMEIssuerDNS01ProviderSakuraCloud)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud_To_acme_ACMEIssuerDNS01ProviderSakuraCloud(a.(*v1alpha2.ACMEIssuerDNS01ProviderSakuraCloud), b.(*acme.ACMEIssuerDNS01ProviderSakuraCloud), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*acme.ACMEIssuerDNS01ProviderSakuraCloud)(nil), (*v1alpha2.ACMEIssuerDNS01ProviderSakuraCloud)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_acme_ACMEIssuerDNS01ProviderSakuraCloud_To_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud(a.(*acme.ACMEIssuerDNS01ProviderSakuraCloud), b.(*v1alpha2.ACMEIssuerDNS01ProviderSakuraCloud), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ACMEChallengeSolverDNS01_To_acme_ACMEChallengeSolverDNS01(in *v1alpha2.ACMEChallengeSolverDNS01, out *acme.ACMEChallengeSolverDNS01, s conversion.Scope) error {
	...
	out.SakuraCloud = (*acme.ACMEIssuerDNS01ProviderSakuraCloud)(unsafe.Pointer(in.SakuraCloud))
...
func autoConvert_acme_ACMEChallengeSolverDNS01_To_v1alpha2_ACMEChallengeSolverDNS01(in *acme.ACMEChallengeSolverDNS01, out *v1alpha2.ACMEChallengeSolverDNS01, s conversion.Scope) error {
	...
	out.SakuraCloud = (*v1alpha2.ACMEIssuerDNS01ProviderSakuraCloud)(unsafe.Pointer(in.SakuraCloud))
...
func autoConvert_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud_To_acme_ACMEIssuerDNS01ProviderSakuraCloud(in *v1alpha2.ACMEIssuerDNS01ProviderSakuraCloud, out *acme.ACMEIssuerDNS01ProviderSakuraCloud, s conversion.Scope) error {
	// TODO: Inefficient conversion - can we improve it?
	if err := s.Convert(&in.AccessToken, &out.AccessToken, 0); err != nil {
		return err
	}
	// TODO: Inefficient conversion - can we improve it?
	if err := s.Convert(&in.AccessSecret, &out.AccessSecret, 0); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud_To_acme_ACMEIssuerDNS01ProviderSakuraCloud is an autogenerated conversion function.
func Convert_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud_To_acme_ACMEIssuerDNS01ProviderSakuraCloud(in *v1alpha2.ACMEIssuerDNS01ProviderSakuraCloud, out *acme.ACMEIssuerDNS01ProviderSakuraCloud, s conversion.Scope) error {
	return autoConvert_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud_To_acme_ACMEIssuerDNS01ProviderSakuraCloud(in, out, s)
}

func autoConvert_acme_ACMEIssuerDNS01ProviderSakuraCloud_To_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud(in *acme.ACMEIssuerDNS01ProviderSakuraCloud, out *v1alpha2.ACMEIssuerDNS01ProviderSakuraCloud, s conversion.Scope) error {
	// TODO: Inefficient conversion - can we improve it?
	if err := s.Convert(&in.AccessToken, &out.AccessToken, 0); err != nil {
		return err
	}
...
// Convert_acme_ACMEIssuerDNS01ProviderSakuraCloud_To_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud is an autogenerated conversion function.
func Convert_acme_ACMEIssuerDNS01ProviderSakuraCloud_To_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud(in *acme.ACMEIssuerDNS01ProviderSakuraCloud, out *v1alpha2.ACMEIssuerDNS01ProviderSakuraCloud, s conversion.Scope) error {
	return autoConvert_acme_ACMEIssuerDNS01ProviderSakuraCloud_To_v1alpha2_ACMEIssuerDNS01ProviderSakuraCloud(in, out, s)
}
