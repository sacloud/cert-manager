...
func (in *ACMEChallengeSolverDNS01) DeepCopyInto(out *ACMEChallengeSolverDNS01) {
	*out = *in
	...
	if in.SakuraCloud != nil {
		in, out := &in.SakuraCloud, &out.SakuraCloud
		*out = new(ACMEIssuerDNS01ProviderSakuraCloud)
		**out = **in
	}
	if in.AcmeDNS != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACMEIssuerDNS01ProviderSakuraCloud) DeepCopyInto(out *ACMEIssuerDNS01ProviderSakuraCloud) {
	*out = *in
	out.AccessToken = in.AccessToken
	out.AccessSecret = in.AccessSecret
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACMEIssuerDNS01ProviderSakuraCloud.
func (in *ACMEIssuerDNS01ProviderSakuraCloud) DeepCopy() *ACMEIssuerDNS01ProviderSakuraCloud {
	if in == nil {
		return nil
	}
	out := new(ACMEIssuerDNS01ProviderSakuraCloud)
